...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ScrimsServerLess*):
...
Execute unit tests
```
    cd "ScrimsServerLess/test/ScrimsServerLess.Tests"
    dotnet test
```

Deploy application
```
    cd "ScrimsServerLess/src/ScrimsServerLess"
